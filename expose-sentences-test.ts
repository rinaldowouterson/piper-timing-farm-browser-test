...
export const TEST_BATTERY = {
  LONG_PARAGRAPHS_EN: Array.from({ length: 100 }, (_, i) => 
    `[EN-SENTENCE-${i + 1}] The industrial revolution was a major turning point in history, transforming the way people lived and worked through the introduction of machinery and new manufacturing processes. It began in Great Britain in the late eighteenth century and eventually spread to other parts of the world, leading to profound economic, social, and cultural changes that still resonate today. (Index: ${i + 1})`
  ),
  LONG_PARAGRAPHS_UK: Array.from({ length: 100 }, (_, i) => 
    `[UK-SENTENCE-${i + 1}] Промислова революція стала важливим поворотним моментом в історії, змінивши спосіб життя та праці людей завдяки впровадженню машин та нових виробничих процесів. Вона розпочалася у Великобританії наприкінці вісімнадцятого століття і зрештою поширилася на інші частини світу, призвівши до глибоких економічних, соціальних та культурних змін. (Індекс: ${i + 1})`
  ),
  QUICK_PHRASES: [
    "Hello world.",
    "Quick test.",
